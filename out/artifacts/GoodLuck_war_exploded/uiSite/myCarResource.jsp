...
<%
  ...
  if(null==name){
    ...
    carInfos = (ArrayList<CarInfo>) request.getAttribute("car");
  }
%>
  ...
  <div class="table_content"  id="fullTruckItems">
    <table id="tab" class="table_gray J_transPopBtn">
      ...
      <tr class="odd gradeX">
        ...
        <td data-id="<%=c.getId()%>" onclick="delUploadTr(this)">删除</td>
      </tr>
      <%}%>
      </tbody>
    </table>
...
<script type="text/javascript">
  ...
  $("#J_fullTruck_btn").click(function(){
    ...
    function createTr(obj){
      ...
      var $td=$("<td></td>");
      $td.html('<img src="images/indentity.png" width="22" height="22">');
      $tr.append($td);
