...
$(function(){
	function e(){
		c=$(".listT li").eq(d).find(".year").html();
		...
		$(".listT .liwrap").mouseover(function(){
			$(".listT li").removeClass("thiscur");
			$(this).parent().addClass("thiscur")
		});
		var b=0,f=$(".listT li").length,d=0,a=!0,c;
		(function(){
			var a=$(window).height();
			890<=a&&(row=6);
			800<=a&&890>a&&(row=5);
		...
		var h=f-row;
		$(".listT").height(110*row);
		$("#contentTime").height(110*row+25);
		$.fn.liOut=function(){
		...
		$(".arrowdown").click(function(){
			a&&parseInt($(".listT li:first").css("marginTop"))> -110*h&&(d++,b--,a=!1,$(".listT li").eq(d-1).liOut(),$(".listT li").eq(d+row-1).liIn(),$(".listT li:first").animate({marginTop:110*b},600,"easeInOutQuad",function(){
				a=!0;$(".arrowdown").css("opacity",1);
				$(".arrowdown").removeClass("arrow_active")
			}),e()
		)});
		$(".arrowup").click(function(){
			a&&0!=parseInt($(".listT li:first").css("marginTop"))&&(b++,d--,a=!1,$(".listT li").eq(d).liIn(),$(".listT li").eq(d+row).liOut(),$(".listT li:first").animate({marginTop:110*b},600,"easeInOutQuad",function(){
				a=!0;$(".arrowup").css("opacity", 1);
				$(".arrowup").removeClass("arrow_active")
			}),e()
		)});
		$(".listT").mousewheel(function(b,c){
			Math.abs(c);
			if(a){
				var d=parseInt($(".listT li:first").css("marginTop"));
		...
		$(".timeblock").attr("thisyear",c);
		$(".listT li:gt("+(row-1)+")").find(".lileft").css({left:"-400px"});
		$(".listT li:gt("+(row-1)+")").find(".liright").css({right:"-700px"});
