function homeSelCity(obj,e) {
    ...
    $("#_citys0 a").click(function () {
        ...
        $(ths.parentElement).find("#myCity")[0].innerText = $(this).data("name");
        ...
        $("#_citys1 a").click(function () {
            ...
            var bc = $("#hcity").val();
            $(ths.parentElement).find("#myCity")[0].innerText = /*bc+ "-" +*/ $(this).data("name");

            sessionStorage.cityName=$("#myCity").text();
            var name = $('#login').text();
            if(name!='登录'){
                viewPhone();
            }else{
            ...
            var currentCity = bc+ "-" + $(this).data("name");
            /* var ar = getArea($(this));*/
...
function SelCity(obj,e) {
    ...
    var dal = '<div class="_citys">' +
        ...
        '<ul id="_citysheng" class="_citys0"><li class="citySel">省份</li><li>城市</li><!--<li>区县</li>--></ul>' +
